import 'dart:convert';
import 'package:customer_identity/src/core/themes/styles/appbar_theme_style.dart';
import 'package:customer_identity/src/core/themes/styles/bottom_bar_theme_style.dart';
import 'package:customer_identity/src/core/themes/styles/elevated_button_theme_style.dart';
import 'package:customer_identity/src/core/themes/styles/input_decoration_theme_style.dart';
import 'package:customer_identity/src/core/themes/styles/outlined_button_theme_style.dart';
...
abstract class CoreTheme{
  ...
  Future<CoreTheme> init() async{
    try{
      String data = await rootBundle.loadString('packages/customer_identity/assets/themes/$fileName.json');
  ...
  ThemeData buildTheme(BuildContext context){
    return themeData.copyWith(
      ...
      outlinedButtonTheme: OutlinedButtonThemeStyle.outlinedButtonStyle(primaryColor),
